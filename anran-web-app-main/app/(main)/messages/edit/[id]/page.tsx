...
function MessagesEdit({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        ...
        API.get('messages/' + id).then(function (response: any) {
            formik.setFieldValue('msg', response.data.msg, false);
            formik.setFieldValue('image_url', response.data.image_url, false);
            formik.setFieldValue('image_data_url', new Date(response.data.image_data_url), false);
            formik.setFieldValue('msg_type', response.data.msg_type, false);
            formik.setFieldValue('status_active', response.data.status_active, false);
            formik.setFieldValue('allways', response.data.allways, false);
            formik.setFieldValue('sortorder', response.data.sortorder, false);
            formik.setFieldValue('startdate', stringasUTC(response.data.startdate), false);
            formik.setFieldValue('enddate', stringasUTC(response.data.enddate), false);
        ...
        onSubmit: (data: any) => {
            confirmDialog({
                ...
                accept() {
                    ...
                    API.put('messages/' + id, data).then(function (response) {
                        if (toast && toast.current) {
