...
function StaffUpdate({ params }: { params: { id: string } }) {
    ...
    function findArrayElementByName(array: any, title: any) {
    ...
    useEffect(() => {
        ...
        API.get('staff/' + id).then(function (response: any) {
            formik.setFieldValue('name', response.data.name, false);
            formik.setFieldValue('staff_code', response.data.staff_code, false);
            formik.setFieldValue('gender', findArrayElementByName(gender, response.data.gender), false);
            formik.setFieldValue('roles', response.data.roles, false);
            formik.setFieldValue('joingdate', new Date(response.data.joingdate), false);
            formik.setFieldValue('branch', response.data.branch, false);
            formik.setFieldValue('username', response.data.username, false);
            formik.setFieldValue('loginkey', response.data.loginkey, false);
            formik.setFieldValue('status_active', response.data.status_active, false);
            formik.setFieldValue('emailaddress', response.data.emailaddress, false);
            formik.setFieldValue('position_department', response.data.position_department, false);
            formik.setFieldValue('fullname', response.data.fullname, false);
            formik.setFieldValue('nirc', response.data.nirc, false);
            formik.setFieldValue('religion', response.data.religion, false);
            formik.setFieldValue('mobilenumber', response.data.mobilenumber, false);
            formik.setFieldValue('martialstatus', response.data.martialstatus, false);
            formik.setFieldValue('currentaddress', response.data.currentaddress, false);
            formik.setFieldValue('bankname', response.data.bankname, false);
            formik.setFieldValue('bankaccountnumber', response.data.bankaccountnumber, false);
            formik.setFieldValue('banksocsono', response.data.banksocsono, false);
            formik.setFieldValue('bankepfno', response.data.bankepfno, false);
            formik.setFieldValue('bankincometaxno', response.data.bankincometaxno, false);
            formik.setFieldValue('emergency_contactname', response.data.emergency_contactname, false);
            formik.setFieldValue('emergency_relation', response.data.emergency_relation, false);
            formik.setFieldValue('emergency_contact', response.data.emergency_contact, false);
        }).catch(function (error) {
            console.log(error);
        });
    }, []);
        ...
        onSubmit: (data: any) => {
            confirmDialog({
                ...
                accept() {
                    ...
                    API.put('staff/' + id, subobj).then(function (response) {
                        if (toast && toast.current) {
                            toast.current.show({ severity: 'info', summary: 'Status', detail: 'Staff Updated Successfully!!!', life: 3000 });
                        }
                        formik.resetForm();
                        router.push("/staff/summary");
                    }).catch(function (error) {
                        if (toast && toast.current) {
                            toast.current.show({ severity: 'error', summary: 'Status', detail: 'Staff Not able to Update', life: 3000 });
                        }
                    });
                    setBlocked(false);
                },
