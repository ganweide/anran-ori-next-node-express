...
function BookingCreate({ params }: { params: { bid: string, frd: String, tod: string } }) {
    const { bid, frd, tod } = params;
            ...
            <BlockUI blocked={blocked}>
                ...
                <form onSubmit={memberform.handleSubmit} className="field mb-12 col-12">
                    ...
                    <div className="grid p-fluid formgrid">
                        ...
                        <div className="col-12 md:col-12 field"></div>
                    ...
                    <div className="col-12">
                        <Button type="submit" label="Save Booking" icon="pi pi-check" />
                    </div>
                </form>
