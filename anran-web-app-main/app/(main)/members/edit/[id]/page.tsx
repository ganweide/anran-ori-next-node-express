...
function MembersEdit({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [packageResponse, branchResponse, memberResponse] = await Promise.all([
                    API.get(`package`),
                    API.get(`branch`),
                    API.get(`Members/${id}`)
                ]);
                ...
                memberform.setFieldValue('member_date', new Date(memberData.member_date), false);
                memberform.setFieldValue('member_name', memberData.member_name || '', false);
                memberform.setFieldValue('status', memberData.status || '', false);
                memberform.setFieldValue('existingmobileno', memberData.existingmobileno || '', false);
                memberform.setFieldValue('preferredbranch', memberData.preferredbranch || '', false);
                memberform.setFieldValue('paymentmethod', memberData.paymentmethod || '', false);
                memberform.setFieldValue('legalFullname', memberData.legalFullname || '', false);
                memberform.setFieldValue('preferredname', memberData.preferredname || '', false);
                memberform.setFieldValue('chinesename', memberData.chinesename || '', false);
                memberform.setFieldValue('passport', memberData.passport || '', false);
                memberform.setFieldValue('age', memberData.age || '', false);
                memberform.setFieldValue('gender', memberData.gender || '', false);
                memberform.setFieldValue('dob', new Date(memberData.dob) || '', false);
                memberform.setFieldValue('address', memberData.address || '', false);
                memberform.setFieldValue('city', memberData.city || '', false);
                memberform.setFieldValue('postcode', memberData.postcode || '', false);
                memberform.setFieldValue('states', memberData.states || '', false);
                memberform.setFieldValue('mobileNumber', memberData.mobileNumber || '', false);
                memberform.setFieldValue('email', memberData.email || '', false);
                memberform.setFieldValue('aboutus', memberData.aboutus || '', false);
                memberform.setFieldValue('medicalhistory', memberData.medicalhistory || '', false);
                memberform.setFieldValue('suffered', memberData.suffered || [], false);
                memberform.setFieldValue('healthrelatedissue', true, false);
                memberform.setFieldValue('emergencyName', memberData.emergencyName || '', false);
                memberform.setFieldValue('emergencymobile', memberData.emergencymobile || '', false);
                memberform.setFieldValue('emergencyrelationship', memberData.emergencyrelationship || '', false);
                memberform.setFieldValue('agree', memberData.agree || '', false);
                setChecked(memberData.suffered || []);
                loadDobChange(new Date(memberData.dob))
            } catch (error) {
    ...
    const onSufferedChange = (e: any) => {
        const newChecked = [...checked];
        if (e.checked) {
            newChecked.push(e.value);
        } else {
            const index = newChecked.indexOf(e.value);
            if (index !== -1) {
                newChecked.splice(index, 1);
            }
        }
        setChecked(newChecked);
        memberform.setFieldValue('suffered', newChecked, false);
    };
    ...
    const handleDobChange = (e: any) => {
        ...
        memberform.setFieldValue('dob', selectedDate);
        const calculatedAge = calculateAge(selectedDate);
        memberform.setFieldValue('age', calculatedAge);
    };

    const loadDobChange = (e: Date) => {
